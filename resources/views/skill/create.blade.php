    ...
    <form action="{{url('/skill')}}" method="post">
      ...
      <div class="input-group mx-auto" style="width: 500px; ">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" name="percentage" class="form-control" placeholder="between 0 to 100" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
